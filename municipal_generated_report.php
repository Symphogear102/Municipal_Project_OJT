...
$caseinfo = $getClient->displayAllCASEInfo();
$familyinfo = $getClient->displayClientFamilyBackGround();
$recommendation = $getClient->displayClientRecommendation();

// $pdf = new PDF();

$pdf = new PDF_Municipal_Report();
...
// $y = $pdf->GetY();
// $y1 = $pdf->GetY();
// $pdf->Line(5, $y1+8, 207, $y1+$h);
// $y = $pdf->GetY();
// $pdf->MultiCell(35,4,$info['famName'].' Victoriano',0,'C');
// $y1 = $pdf->GetY();
// $pdf->SetY($y);
// $pdf->Cell(35,8,'');
