...
<div class="container-fluid">
    ...
    <div class="col-xl-12 col-lg-6">
        <div class="card shadow mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary">CREATE CASE STUDY (Client List)</h6>
            </div>
            <div class="card-body ">
                <!-- Data table -->
                <table id="dtBasicExample" class="table table-bordered table-hover dt-responsive text-center" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a  href="S_caseStudies.php?clientID=<?php echo $info['cCTR'] ?>">
                                    <button class="btn btn-primary" type="button" name="caseSubmit">
