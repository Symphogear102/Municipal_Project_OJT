...
<div class="container-fluid">
    <div>        
        <nav aria-label="breadcrumb" class="main-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="S_caseStudies.php">Client Info</a></li>
            <li class="breadcrumb-item active" aria-current="page">Food Assistance</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="col-xl-12   ">
        <div class="card shadow mb-4">
            ...
            <form action="" method="post">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="hidden" name="getAssitantType" value="4" readonly> 
                    ...
                    <input class="form-control" type="hidden" name="typeOfAssistance" id="typeofAssistance" value="Food Case Study" readonly> 
                ...
                <input class="form-control" type="text" name="clientFullName" value="<?php echo $staffInfo['firstName']; ?> <?php echo $staffInfo['middleName']; ?> <?php echo $staffInfo['lastName']; ?>" readonly> 
                    ...
                    <input class="form-control" type="hidden" name="unsettledAmount" placeholder="0.00" value="0.00" required> 

                    <!-- <label for="fName">Name of the Patient:</label> -->


                    <!-- <label for="mName">Anong klaseng Assistant (financial/medical)?:</label> -->                    
                    <input class="form-control" type="hidden" name="problemPresented2"  value="Food Assistance" required> 
            ...
            <select id="inputState" class="form-control" name="problemPresented2">
              ...
              <option value="medical"> medical </option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="hidden" name="problemPresented4" placeholder="Enter relationship" value="N/A" required> 
                
            
                    <!-- <label for="mName">Based on the medical certificate, enter the condition of the client:</label> -->
                    <input class="form-control" type="hidden" name="problemPresented5"  placeholder="Enter condition of the patient" value="N/A" required> 
            
                
                    <!-- <label for="lName">Purpose of the assistance:</label> -->
                    <input class="form-control" type="hidden" name="problemPresented6" placeholder="Enter purpose of the assistance" required> 
        ...
        <div class="form-group mb-4 text-center">
            <button type="submit" class="btn btn-primary mx-4 px-5" name="insertCaseFO">Submit</button>
        </div>
        </form>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      (Copy/Edit)
        <?php $value = 'In view of the forgoing information, the undersigned worker respectfully recommends (NAME OF CLIENT) to avail food assistance from your good office (OFFICE NAME/POLITICAL FIGURE) due to their indigent condition, (he/she) is found eligible in the said services' ?>
        <textarea name="recommendation" id="" cols="60" rows="10" required><?= $value ?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
