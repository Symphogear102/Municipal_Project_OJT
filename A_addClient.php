    ...
    <div class="card-body ">
     ...
     <h6 class="text text-uppercase py-2"> Personal Information: </h6>
      ...
      <div class="d-flex justify-content-center">
        <button type="submit" name="A_addClient" class="btn btn-outline-primary  btn-lg align-center px-5 "> <i class="fa fa-user-plus" aria-hidden="true"> Add Users </i> </button>
      </div>
      </form>
    </div>
  </div>
