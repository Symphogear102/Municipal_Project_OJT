        ...
        <div class="card">
          <div class="card-body">
            <div class="text-center">
              <img src="img/<?php echo $showUpdate['userImage']; ?>" alt="Staff" class="rounded-circle shadow-4-strong " width="180px" height="180px">
            </div>
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
              <?php echo $showUpdate['staffPosition']; ?>
              </div>
            </div>
            <hr>
            <div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="d-flex flex-column align-items-center text-center">
          <img src="img/<?php echo $showUpdate['userImage']; ?>" alt="Staff" class="rounded-circle" width="150">
        </div>
        <div class="mt-4 text-center">
          <h4><?php echo $showUpdate['userFirst']; ?> <?php echo $showUpdate['userMid']; ?> <?php echo $showUpdate['userLast']; ?></h4>
            <p> Position:  Staff</p>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="d-flex justify-content-center">
          <button type="submit" name="update_S" class="btn btn-dark px-5 my-2">Save changes</button>
        </div>
      </div>
