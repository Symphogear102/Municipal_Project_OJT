    ...
    <div class="col-xl-12 col-lg-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">ADD FOOD ASSISTANCE (Client List)</h6>
            </div>
            <div class="card-body ">
                <!-- Data table -->
                <table id="dtBasicExample" class="table table-bordered table-hover dt-responsive text-center" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a  href="S_addFood.php?clientID=<?php echo $info['cCTR'] ?>">
                                    <button class="btn btn-primary" type="button" name="addFO">
