...
$caseinfo = $getClient->displayAllFOODInfo();
$familyinfo = $getClient->displayFoodFamiliyBackground();
$recommendation = $getClient->displayFoodRecommendation();

// $pdf = new PDF();

$pdf = new PDF_Food_Report();
