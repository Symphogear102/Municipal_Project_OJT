            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800 mb-5">Server is Down...</p>
                        <p class="text-gray-500 mb-0">The server has been shut down by the Super Admin...</p>
                        <p class="text-gray-500 mb-0">If you think this is a mistake, please contact them immediately.</p>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; MSWDO Portal 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
