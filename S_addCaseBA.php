...
<div class="container-fluid">
    ...
    <div class="col-xl-12   ">
        <div class="card shadow mb-4">
            ...
            <form action="" method="post">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="hidden" name="clientCode" id="clientCode" value="<?php echo $staffInfo['clientCode']; ?>" readonly> 
                    ...
                    <input class="form-control" type="hidden" name="typeOfAssistance" id="typeofAssistance" value="Burial Case Study" readonly>                 
                </div>    
                ...
                <div class="form-group col-md-6">
                    <label for="fName">Name of the Deceased:</label>
                    <input class="form-control" type="text" name="problem1" placeholder="Name of the Deceased" required> 
                </div>
                
                <div class="form-group col-md-6">
                    <!-- <label for="mName">Anong klaseng Assistant (financial/medical)?:</label> -->
                    <input class="form-control" type="hidden" name="problem2"  placeholder="Type of Assistance" value="Burial" required> 
                </div>

                <div class="form-group col-md-6">
                    <label for="lName">From which office/political figure are you asking assistance from:</label>
                    <input class="form-control" type="text" name="problem3" placeholder="Enter name of Office/Political Figure" required> 
                </div>
            
                <div class="form-group col-md-6">
                    <label for="fName">Relationship to the client/patient:</label>
                    <input class="form-control" type="text" name="problem4" placeholder="Enter relationship" required> 
                </div>
                <div class="form-group col-md-6">
                    <label for="mName">Based on the medical certificate, enter the condition of the client:</label>
                    <input class="form-control" type="text" name="problem5"  placeholder="Enter condition of the patient" required> 
                </div>
                <div class="form-group col-md-6">
                    <label for="lName">Purpose of the assistance:</label>
                    <input class="form-control" type="text" name="problem6" placeholder="Enter purpose of the assistance" required>                 
                </div>
        ...
        <div class="form-group mb-4 text-center">
            <button type="submit" class="btn btn-primary mx-4 px-5" name="BurialCaseStudy">Submit</button>
        </div>
        </form>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      (Copy/Edit)
        <?php $value = 'In view of the forgoing information, the undersigned worker respectfully recommends (NAME OF CLIENT) to avail burial assistance from your good office (OFFICE NAME/POLITICAL FIGURE) due to their indigent condition, (he/she) is found eligible in the said services' ?>
        <textarea name="recommendation" id="" cols="60" rows="10" required><?= $value ?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
