    ...
    <div>
        <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="A_clientHistory.php">Staff List</a></li>
                <li class="breadcrumb-item active" aria-current="page">Displaying Staff History...</li>
            </ol>
        </nav>
    </div>
    <!-- Page Heading -->
            ...
            <div class="card-body ">
                ...
                <table id="dtBasicExample" class="table table-bordered table-hover dt-responsive text-center" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><?php  echo $customer['userCode'];  ?></td>
