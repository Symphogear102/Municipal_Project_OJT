...
<div class="container-fluid">
    ...
    <div class="col-xl-12   ">
        <div class="card shadow mb-4">
            ...
            <form action="" method="post">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="hidden" name="getAssitantType" value="3" readonly> 
                    ...
                    <input class="form-control" type="hidden" name="typeOfAssistance" id="typeofAssistance" value="Medicine Case Study" readonly>
                ...
                <div class="form-group col-md-6">
                    <label for="fName">Medicine Cost:</label>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="text" name="problemPresented1" placeholder="Enter Name of Client" required> 
                </div>

                <div class="form-group col-md-6">
                    <!-- <label for="mName">Anong klaseng Assistant (financial/medical)?:</label> -->
                    <input class="form-control" type="hidden" name="problemPresented2"  value="Medical" required> 
                </div>
        ...
        <div class="form-group mb-4 text-center">
            <button type="submit" class="btn btn-primary mx-4 px-5" name="insertCaseMA">Submit</button>
        </div>
        </form>
        </div>
    </div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      (Copy/Edit)
        <?php $value = 'In view of the forgoing information, the undersigned worker respectfully recommends (NAME OF CLIENT) to avail medical assistance from your good office (OFFICE NAME/POLITICAL FIGURE) due to their indigent condition, (he/she) is found eligible in the said services' ?>
        <textarea name="recommendation" id="" cols="60" rows="10" required><?= $value ?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
