...
<div class="container-fluid">
    <div>
        <nav aria-label="breadcrumb" class="main-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="S_foodAssistance.php">Select Client</a></li>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control" type="hidden" name="typeOfAssistance" id="typeofAssistance" value="Food Assistance" readonly> 
            ...
            <button type="submit" class="btn btn-primary my-4 px-5 " name="addFood">Submit</button>
            </form>
        </div>
    </div>
</div>
